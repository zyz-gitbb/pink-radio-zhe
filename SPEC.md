...
- **样式**: Tailwind CSS + 自定义暗色赛博风主题
- **状态管理**: React Context + useReducer
- **部署**: Vercel（零运维、自动部署）
- **数据存储**: 纯 localStorage（无后端数据库）
...
### 3.1 视觉风格
- **主题**: 暗色/赛博风
- **配色**: 深色背景（#0a0a0f）+ 霓虹色点缀（青色 #00f0ff、紫色 #a855f7、粉色 #ec4899）
- **字体**: 中文使用系统默认字体，英文使用 Inter 或 JetBrains Mono
- **圆角**: 8px-12px
- **阴影**: 使用霓虹色发光效果

### 3.2 页面布局
- **整体结构**: 左侧固定导航栏 + 右侧内容区
- **导航栏**: 宽度 240px，固定左侧，包含 Logo、频道列表、用户操作
- **内容区**: 自适应宽度，右侧滚动
- **播放器**: 底部固定浮动播放器，高度 80px
