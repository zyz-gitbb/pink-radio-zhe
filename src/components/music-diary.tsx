...
import { useMusicDiary } from "@/hooks/use-music-diary";
...
export function MusicDiary({ songId }: MusicDiaryProps) {
  const { entries, loaded, save, remove } = useMusicDiary(songId);
          ...
          >
            ...
            <div className="px-4 pb-3">
              ...
              <div className="flex items-center justify-between mt-1.5">
                ...
                <button
                  onClick={handleSave}
                  className="px-3 py-1 bg-rose-50 text-rose-400 text-[10px] font-medium rounded-lg hover:bg-rose-100 transition-all"
                >
                  存档
                </button>
              </div>
                ...
                {entries.map((entry) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute top-0 right-0 w-5 h-5 rounded flex items-center justify-center opacity-0 group-hover:opacity-100 text-stone-300 hover:text-red-400 transition-all"
                      title="删除"
                    >
                      <Trash2 size={10} />
                    </button>
